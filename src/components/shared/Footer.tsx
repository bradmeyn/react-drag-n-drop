    ...
    <footer className="text-slate-300 mt-auto items-center p-4 bg-neutral text-neutral-content justify-center">
      <div className="text-center">
        <p className=" mb-2 flex items-center justify-center text-sm">
          ...
          <a
            href={"https://www.github.com/bradmeyn/react-drag-n-drop"}
            target="_blank"
            rel="noreferrer"
            className="font-bold flex gap-2 items-center justify-center text-sm text-white underline-offset-2 hover:underline"
          >
            <svg
